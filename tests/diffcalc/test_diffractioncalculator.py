...
class FourCircleForI06Experiment(AdhocTestIncludingExternalScannables):
    ...
    def orient(self):
        ...
        pos_en(1.650)
        newub('cubic')   # This dataset generated by diffcalc code itself (not a proper test of code guts)
        setlat('xtal', 5.34, 5.34, 13.2, 90, 90, 90)
        self.d.setu([[1, 0, 0], [0, 1, 0], [0, 0, 1]])
        hklmode(5)
        set('phi', -90)
    ...
    def testHkl001(self):
        self.pos_hkl(0, 0, 1)
        assert_array_almost_equal(self.pos_fourc(), [33.07329403295449, 16.536647016477247, 90.0, -90.0], note="[delta, omega, chi, phi]")
...
#        assert_array_almost_equal(self.pos_fourc(), [89.42926563609406, 134.71463281804702, 90.0, -90.0], note="[delta, omega, chi, phi]")
    ...
    def testHkl101(self):
        self.pos_hkl(1, 0, 1)
        assert_array_almost_equal(self.pos_fourc(), [98.74666191021282, 117.347760720783, 90.0, -90.0], note="[delta, omega, chi, phi]")
