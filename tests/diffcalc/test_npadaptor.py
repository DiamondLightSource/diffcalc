import unittest
try:
    from diffcalc.numpy2jama import Matrix
###except ImportError:
###    # Really this code is to test this wrapper under Python, but testing agains##
###
###    # The original Jama Matrix will verify that the tests are sensible.
###    from Jama import Matrix
    ...
    #        m = Matrix( (1,2,3) )
        ...
        def testInverse(self):
            ...
            #self.assertAlmostEqual(m1.getArray(), m1inv)
