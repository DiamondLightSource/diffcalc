...
"""[1:])
    ...
    def test_constrain_det_three_preexisting_other(self):
        ...
        try:
            ...
            eq_(e.args[0], 
"""Delta could not be constrained. First un-constrain one of as the angles alpha,
...
chi or phi (with 'uncon')""")
    ...
    def test_constrain_ref_three_preexisting_other(self):
        ...
        try:
            ...
            eq_(e.args[0],
"""Alpha could not be constrained. First un-constrain one of as the angles delta,
chi or phi (with 'uncon')""")
...
chi or phi (with 'uncon')""")
    ...
    def test_constrain_samp_three_preexisting_two_samp_one_det(self):
        ...
        try:
            ...
            eq_(e.args[0],
"""Phi could not be constrained. First un-constrain one of as the angles delta,
eta or chi (with 'uncon')""")
    ...
    def test_constrain_samp_three_preexisting_two_samp_one_ref(self):
        ...
        try:
            ...
            eq_(e.args[0],
"""Phi could not be constrained. First un-constrain one of as the angles alpha,
eta or chi (with 'uncon')""")
    ...
    def test_constrain_samp_three_preexisting_samp(self):
        ...
        try:
            ...
            eq_(e.args[0],
"""Phi could not be constrained. First un-constrain one of as the angles mu,
eta or chi (with 'uncon')""")
...
###
    def test_set_fails(self):
        try:
            ...
            eq_(e.args[0],"Could not set not_a_constraint as this is not an available constraint.")
        
        try:
            self.cm.set('delta', object())
            assert False
        except DiffcalcException, e:
            eq_(e.args[0],"Could not set delta as this is not currently constrained.")
        ...
        try:
            ...
            eq_(e.args[0],"Could not set a_eq_b as this constraint takes no value.")
        ...
        try:
            ...
            eq_(e.args[0],
"""Could not set delta as this constraint is configured to track its associated
physical angle. First remove this tracking (use 'untrack delta').""") 
    ...
    def test_track_fails(self):
        try:
            ...
            eq_(e.args[0],"Could not track not_a_constraint as this is not an available constraint.")
        
        try:
            self.cm.track('delta')
            assert False
        except DiffcalcException, e:
            eq_(e.args[0],"Could not track delta as this is not currently constrained.")
        ...
        try:
            ...
            eq_(e.args[0],"Could not track a_eq_b as this constraint takes no value.")
        ...
        try:
            ...
            eq_(e.args[0],
"""Could not configure alpha to track as this constraint is not associated with a
physical angle.""") 
